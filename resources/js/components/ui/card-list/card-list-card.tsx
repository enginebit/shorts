/**
 * CardListCard Component
 * 
 * Migrated from: /Users/yasinboelhouwer/shorts/dub-main/packages/ui/src/card-list/card-list-card.tsx
 * 
 * Adaptations for Laravel + Inertia.js:
 * - Replaced @dub/utils with local utils
 * - Maintained exact visual consistency with dub-main
 * - Preserved all hover state management and click handling
 * 
 * Key Features:
 * - Compact and loose variants with different styling
 * - Hover state detection with cleanup for modals
 * - Interactive child click prevention
 * - Banner support for additional content
 */

import { cn, isClickOnInteractiveChild } from '@/lib/utils';
