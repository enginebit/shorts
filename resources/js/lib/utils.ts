 ...
 * Following dub-main patterns from /lib/utils.ts
 */
...
/**
 * Check if click is on interactive child element
 * Migrated from dub-main utils
 */
export function isClickOnInteractiveChild(e: React.MouseEvent): boolean {
