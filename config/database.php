...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'supabase' => [
            ...
            'username' => env('SUPABASE_DB_USERNAME', 'postgres.yoqmmgxkbyuhcnvqvypw'),
    ...
    */
    ...
    'redis' => [
        ...
        // Dedicated connection for link caching (following dub-main patterns)
        'links' => [
            'url' => env('REDIS_URL'),
            'host' => env('REDIS_HOST', '127.0.0.1'),
            'username' => env('REDIS_USERNAME'),
        ...
        // Dedicated connection for analytics and metrics
        'analytics' => [
            'url' => env('REDIS_URL'),
            'host' => env('REDIS_HOST', '127.0.0.1'),
            'username' => env('REDIS_USERNAME'),
